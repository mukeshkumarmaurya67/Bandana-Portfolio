    ...
    <>
          ...
          <div className="row">
            <div className="col-lg-7 align-self-center">
              ...
              <p className="com-para">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos dolorum tempora fugiat doloremque eveniet sint sunt iure eaque dolorem molestiae! Autem, nulla? Eius odit fuga possimus! Cupiditate deserunt asperiores quae.
              </p>
              <button className="btn btn-danger">Learn More</button>
            </div>
            <div className="col-lg-5">
              <img src={require(`../assets/images/hero_img.png`)} alt="" className='img-fluid' />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="row mt-5">
            <div className="col-lg-4">
              <h3 className="sm-title">Developing With a Passion While Exploring The World.</h3>
              <p className="com-para pe-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam itaque eius nulla laudantium. Recusandae doloremque mollitia vero eum impedit ipsa eligendi voluptatum perferendis possimus ex natus, nesciunt ducimus iusto voluptatem.</p>
              <p className="com-para pe-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur eos officia </p>
              <button className='btn btn-danger'>Contact Me</button>
            </div>
            <div className="col-lg-4 align-self-center">
              <p className="com-para">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repellat ea tenetur natus rem assumenda ipsa, accusamus quo ab quidem id cupiditate optio sed, perferendis esse provident dolor sit unde perspiciatis.</p>
            </div>
          ...
          <div className="row mt-5">
            <div className="col-lg-4">
              <div className="service-content">
                ...
                <p className="com-para text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="service-content">
      ...
      <section className="bg-img-wrapper">
        <div className="container">
          ...
          <p className="com-para text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus,
          ...
          <div className="row mt-5">
            <div className="col-lg-6">
              <div className="work-exp-content">
                ...
                <h5>2015-2018</h5>
                <p className='com-para'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
